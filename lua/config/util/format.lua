...
function M.info(buf)
	...
	Config[enabled and "info" or "warn"](
		table.concat(lines, "\n"),
...
function M.format(opts)
	...
	if not done and opts and opts.force then
		Config.warn("No formatter available", { title = "Formatter" })
	end
end
...
function M.snacks_toggle(buf)
	return require("snacks").toggle({
		...
		get = function()
			...
			return Config.format.enabled()
		end,
		set = function(state)
			Config.format.enable(state, buf)
		end,
	})
end
